...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/termupdate.css">
<head>
...
<div class="up-form">
  ...
  <div class="form-panel one">
    ...
    <form action="<c:url value='/term/update'/>" method="post">
      <!--  <form> -->
      <div class="form-group-left">
        ...
        <div class="form-group">
          ...
          <input type="text" id="termEngAbbn" name="termEngAbbn" value="${term.termEngAbbn}" />
        </div>
        <div class="form-group">
          <label for="password">등록자</label>
          <input type="text" id="regId" name="regId" value="${term.regId}" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="aprvStts" name="aprvStts" value="${term.aprvStts}" />
        </div>
        <div class="form-group-des">
          <label for="password">용어설명</label>
          <input type="text" id="termExpln" name="termExpln" value="${term.termExpln}" />
        </div>
       </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="termNm" name="termNm" value="${term.termNm}" />
        </div>
        <div class="form-group">
          <label for="password">용어도메인타입</label>
          <input type="text" id="termDnm" name="termDnm" value="${term.termDnm}" />
        </div>
        <div class="form-group">
