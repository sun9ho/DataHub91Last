...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/domaindetail.css">
<head>
...
<div class="up-form">
  ...
  <div class="form-panel one">
    ...
    <form action="<c:url value='/domain/update'/>" method="get">
     <!--  <form> -->
      <div class="form-group-left">
        <div class="form-group">
          <label for="password">도메인번호</label>
          <input type="text" id="wordNo" name="wordNo" value="${domain.domainNo}" readonly/>
        </div>
        
        <div class="form-group">
          <label for="password">도메인그룹명</label>
          <input type="text" id="wordEngAbbn" name="wordEngAbbn" value="${domain.domainGnm}" readonly/>
        </div>
        <div class="form-group">
          <label for="password">등록자</label>
          <input type="text" id="regId" name="regId" value="${domain.regId}" readonly/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" id="aprvStts" name="aprvStts" value="${domain.aprvStts}" readonly/>
        </div>
        <div class="form-group-des">
          <label for="password">단어 설명</label>
          <input type="text" id="wordExpln" name="wordExpln" value="${domain.domainExpln}" readonly/>
        </div>
       </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="wordNm" name="wordNm" value="${domain.domainNm}" readonly/>
        </div>
        <div class="form-group">
          <label for="password">도메인타입</label>
          <input type="text" id="wordEngNm" name="wordEngNm" value="${domain.domainCatg}" readonly/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <div class="btn_mdfcn">
        <a href="<c:url value='/domain/update?domainno=${domain.domainNo}'/>"><button type="button" class="btn btn-primary">수정</button></a>
        </div>
        </div>
		  ...
		  <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		    ...
		    <div class="modal-content">
		     ...
		     <div class="modal-body">"${domain.domainNm}"를 도메인테이블에서 삭제하시겠습니까?</div>
