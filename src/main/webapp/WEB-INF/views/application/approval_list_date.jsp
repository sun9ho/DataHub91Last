         ...
         <table class="table table-sm table-bordered">
            <tr>
               <td colspan="4" class="text-center">
                  <div>
                     <a class="btn btn-outline-primary btn-sm" href="approvedate?pageNo=1&select1=${select1}&select2=${select2}">처음</a>
                     <c:if test="${pager.groupNo>1}">
                        <a class="btn btn-outline-info btn-sm"
                           href="approvedate?pageNo=${pager.startPageNo-1}&select1=${select1}&select2=${select2}">이전</a>
                     </c:if>
                     ...
                     <c:if test="${pager.groupNo<pager.totalGroupNo}">
                        <a class="btn btn-outline-info btn-sm"
                           href="approvedate?pageNo=${pager.endPageNo+1}&select1=${select1}&select2=${select2}">다음</a>
                     </c:if>
                     <a class="btn btn-outline-primary btn-sm"
                        href="approvedate?pageNo=${pager.totalPageNo}&select1=${select1}&select2=${select2}">맨끝</a>
                  </div>
               </td>
            </tr>
         </table>
					...
					<tbody>
			         ...
			         <table class="table table-sm table-bordered">
			            <tr>
			               <td colspan="4" class="text-center">
			                  <div>
			                     <a class="btn btn-outline-primary btn-sm" href="approvedate?pageNoD=1&select1=${select1}&select2=${select2}">처음</a>
			                     <c:if test="${pagerD.groupNo>1}">
			                        <a class="btn btn-outline-info btn-sm"
			                           href="approvedate?pageNoD=${pagerD.startPageNo-1}&select1=${select1}&select2=${select2}">이전</a>
			                     </c:if>
			                     ...
			                     <c:if test="${pagerD.groupNo<pagerD.totalGroupNo}">
			                        <a class="btn btn-outline-info btn-sm"
			                           href="approvedate?pageNoD=${pagerD.endPageNo+1}&select1=${select1}&select2=${select2}">다음</a>
			                     </c:if>
			                     <a class="btn btn-outline-primary btn-sm"
			                        href="approvedate?pageNoD=${pagerD.totalPageNo}&select1=${select1}&select2=${select2}">맨끝</a>
			                  </div>
			               </td>
			            </tr>
			         </table>
					...
					<div class="table-responsive custom-table-responsive">
						...
						<table class="table table-sm table-bordered">
							<tr>
								<td colspan="4" class="text-center">
									<div>
										<a class="btn btn-outline-primary btn-sm" href="approvedate?pageNoT=1&select1=${select1}&select2=${select2}">처음</a>
										<c:if test="${pagerT.groupNo>1}">
											<a class="btn btn-outline-info btn-sm"
												href="approvedate?pageNoT=${pagerT.startPageNo-1}&select1=${select1}&select2=${select2}">이전</a>
										</c:if>
										...
										<c:if test="${pagerT.groupNo<pagerT.totalGroupNo}">
											<a class="btn btn-outline-info btn-sm"
												href="approvedate?pageNoT=${pagerT.endPageNo+1}&select1=${select1}&select2=${select2}">다음</a>
										</c:if>
										<a class="btn btn-outline-primary btn-sm"
											href="approvedate?pageNoT=${pagerT.totalPageNo}&select1=${select1}&select2=${select2}">맨끝</a>
									</div>
								</td>
							</tr>
						</table>
					...
					<div class="table-responsive custom-table-responsive">
						...
						<table class="table table-sm table-bordered">
							<tr>
								<td colspan="4" class="text-center">
									<div>
										<a class="btn btn-outline-primary btn-sm" href="approvedate?pageNoM=1&select1=${select1}&select2=${select2}">처음</a>
										<c:if test="${pagerM.groupNo>1}">
											<a class="btn btn-outline-info btn-sm"
												href="approvedate?pageNoM=${pagerM.startPageNo-1}&select1=${select1}&select2=${select2}">이전</a>
										</c:if>
										...
										<c:if test="${pagerM.groupNo<pagerM.totalGroupNo}">
											<a class="btn btn-outline-info btn-sm"
												href="approvedate?pageNoM=${pagerM.endPageNo+1}&select1=${select1}&select2=${select2}">다음</a>
										</c:if>
										<a class="btn btn-outline-primary btn-sm"
											href="approvedate?pageNoM=${pagerM.totalPageNo}&select1=${select1}&select2=${select2}">맨끝</a>
									</div>
								</td>
							</tr>
						</table>   		
