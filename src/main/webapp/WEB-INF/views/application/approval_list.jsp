...
<head>
   ...
   <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/approval_list.css">
   ...
   <div class="bodycontainer">
		<div class="calendar">
			<label for="start">Start date:</label> <input type="date" id="start"
				name="trip-start" value="2022-01-01" min="2022-01-01"
				max="2023-12-31">
			            ...
			            <tr>
			               <td colspan="4" class="text-center">
			                  <div>
			                     ...
			                     <c:if test="${pager.groupNo>1}">
			                        <a class="btn btn-outline-info btn-sm"
			                           href="approve?pageNoD=${pager.startPageNo-1}">이전</a>
			                     </c:if>
			                     ...
			                     <c:if test="${pager.groupNo<pager.totalGroupNo}">
			                        <a class="btn btn-outline-info btn-sm"
			                           href="approve?pageNoD=${pager.endPageNo+1}">다음</a>
			                     </c:if>
			                     <a class="btn btn-outline-primary btn-sm"
			                        href="approve?pageNoD=${pager.totalPageNo}">맨끝</a>
			                  </div>
			               </td>
			            </tr>
			         </table>
